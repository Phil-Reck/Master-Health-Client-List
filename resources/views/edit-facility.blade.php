    ...
    <!-- Main content -->
      ...
      <section class="content">
        ...
        <div class="card card-info">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form id="quickForm" method="POST" action="{{url('/facilities/update')}}" class="form">
                {{csrf_field()}}
              <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="nurses" name="facility_nurses" value="{{$facility_nurses}}" class="form-control" id="doctors" placeholder="11">
                    </div>
                </div>
